...
const verbsDatabase = [
  ...
  },
  {
    ...
    examples: { present: [{"gr": "Μαγειρεύω παστίτσιο σήμερα.", "ru": "Сегодня готовлю пастицио."}, {"gr": "Μαγειρεύεις καλά;", "ru": "Ты хорошо готовишь?"}], aorist: [{"gr": "Μαγείρεψα για όλη την οικογένεια.", "ru": "Приготовил для всей семьи."}, {"gr": "Τι μαγείρεψες χτες;", "ru": "Что ты приготовил вчера?"}], future: [{"gr": "Θα μαγειρέψω σπαγγέτι αύριο.", "ru": "Завтра приготовлю спагетти."}, {"gr": "Θα μαγειρέψεις εσύ;", "ru": "Ты будешь готовить?"}] }
  },
  {
    id: 52, present: "νιώθω", aorist: "ένιωσα", future: "θα νιώσω", translation: "чувствовать", category: "emotion",
    examples: { present: [{"gr": "Νιώθω πολύ καλά σήμερα.", "ru": "Сегодня я чувствую себя очень хорошо."}, {"gr": "Πώς νιώθεις;", "ru": "Как ты себя чувствуешь?"}], aorist: [{"gr": "Ένιωσα χαρά όταν σε είδα.", "ru": "Почувствовал радость, когда тебя увидел."}, {"gr": "Ένιωσα κουρασμένος.", "ru": "Я почувствовал усталость."}], future: [{"gr": "Θα νιώσεις καλύτερα αύριο.", "ru": "Завтра ты будешь чувствовать себя лучше."}, {"gr": "Θα νιώσω ωραία εκεί.", "ru": "Там мне будет хорошо."}] }
  },
  {
    id: 53, present: "νομίζω", aorist: "νόμισα", future: "θα νομίσω", translation: "думать, считать", category: "mental",
    examples: { present: [{"gr": "Νομίζω ότι έχεις δίκιο.", "ru": "Думаю, ты прав."}, {"gr": "Τι νομίζεις;", "ru": "Что ты думаешь?"}], aorist: [{"gr": "Νόμισα ότι ήταν αυτός.", "ru": "Думал, это был он."}, {"gr": "Νόμισα ότι ξέρεις.", "ru": "Думал, ты знаешь."}], future: [{"gr": "Θα νομίσεις ότι λέω ψέματα.", "ru": "Ты подумаешь, что я лгу."}, {"gr": "Θα νομίσω ότι συμφωνεί.", "ru": "Буду думать, что он согласен."}] }
  },
  {
    id: 54, present: "ζω", aorist: "έζησα", future: "θα ζήσω", translation: "жить", category: "daily",
    examples: { present: [{"gr": "Ζω στη Λεμεσό εδώ και δύο χρόνια.", "ru": "Живу в Лимасоле уже два года."}, {"gr": "Πού ζεις;", "ru": "Где ты живёшь?"}], aorist: [{"gr": "Έζησα στην Ελλάδα για πέντε χρόνια.", "ru": "Жил в Греции пять лет."}, {"gr": "Έζησε μια ωραία ζωή.", "ru": "Он прожил хорошую жизнь."}], future: [{"gr": "Θα ζήσω στην Κύπρο για πάντα.", "ru": "Буду жить на Кипре всегда."}, {"gr": "Πού θα ζήσεις;", "ru": "Где ты будешь жить?"}] }
  },
  {
    id: 55, present: "ελπίζω", aorist: "έλπισα", future: "θα ελπίσω", translation: "надеяться", category: "emotion",
    examples: { present: [{"gr": "Ελπίζω να έρθεις.", "ru": "Надеюсь, ты придёшь."}, {"gr": "Ελπίζω να πάει καλά.", "ru": "Надеюсь, всё пройдёт хорошо."}], aorist: [{"gr": "Έλπισα να σε δω.", "ru": "Надеялся тебя увидеть."}, {"gr": "Πάντα έλπιζε.", "ru": "Он всегда надеялся."}], future: [{"gr": "Θα ελπίσω για καλύτερες μέρες.", "ru": "Буду надеяться на лучшие дни."}, {"gr": "Θα ελπίζεις πάντα.", "ru": "Ты всегда будешь надеяться."}] }
  },
  {
    id: 56, present: "προσπαθώ", aorist: "προσπάθησα", future: "θα προσπαθήσω", translation: "стараться, пытаться", category: "mental",
    examples: { present: [{"gr": "Προσπαθώ να μιλώ ελληνικά.", "ru": "Стараюсь говорить по-гречески."}, {"gr": "Προσπαθεί πολύ.", "ru": "Он очень старается."}], aorist: [{"gr": "Προσπάθησα αλλά δεν μπόρεσα.", "ru": "Старался, но не смог."}, {"gr": "Προσπάθησε ξανά.", "ru": "Попробуй снова."}], future: [{"gr": "Θα προσπαθήσω να έρθω νωρίς.", "ru": "Постараюсь прийти рано."}, {"gr": "Θα προσπαθήσεις;", "ru": "Ты постараешься?"}] }
  },
  {
    id: 57, present: "σταματάω", aorist: "σταμάτησα", future: "θα σταματήσω", translation: "останавливаться, прекращать", category: "movement",
    examples: { present: [{"gr": "Σταματάω να καπνίζω.", "ru": "Бросаю курить."}, {"gr": "Σταμάτα εδώ!", "ru": "Остановись здесь!"}], aorist: [{"gr": "Σταμάτησα το αυτοκίνητο.", "ru": "Остановил машину."}, {"gr": "Σταμάτησε τη βροχή.", "ru": "Дождь прекратился."}], future: [{"gr": "Θα σταματήσω εδώ.", "ru": "Остановлюсь здесь."}, {"gr": "Δεν θα σταματήσω ποτέ.", "ru": "Никогда не остановлюсь."}] }
  },
  {
    id: 58, present: "στέλνω", aorist: "έστειλα", future: "θα στείλω", translation: "посылать, отправлять", category: "communication",
    examples: { present: [{"gr": "Στέλνω email κάθε μέρα.", "ru": "Отправляю имейл каждый день."}, {"gr": "Σου στέλνω μήνυμα.", "ru": "Отправляю тебе сообщение."}], aorist: [{"gr": "Έστειλα το γράμμα χτες.", "ru": "Вчера отправил письмо."}, {"gr": "Του έστειλα δώρο.", "ru": "Отправил ему подарок."}], future: [{"gr": "Θα σου στείλω φωτογραφίες.", "ru": "Отправлю тебе фотографии."}, {"gr": "Θα στείλω αίτηση σήμερα.", "ru": "Сегодня отправлю заявку."}] }
  },
  {
    id: 59, present: "φέρνω", aorist: "έφερα", future: "θα φέρω", translation: "приносить", category: "movement",
    examples: { present: [{"gr": "Φέρνω καφέ κάθε πρωί.", "ru": "Приношу кофе каждое утро."}, {"gr": "Φέρε μου νερό!", "ru": "Принеси мне воды!"}], aorist: [{"gr": "Έφερε δώρα για όλους.", "ru": "Принёс подарки для всех."}, {"gr": "Έφερα το βιβλίο σου.", "ru": "Принёс твою книгу."}], future: [{"gr": "Θα σου φέρω κάτι ωραίο.", "ru": "Принесу тебе что-то хорошее."}, {"gr": "Θα φέρω φαγητό.", "ru": "Принесу еду."}] }
  },
  {
    id: 60, present: "φοράω", aorist: "φόρεσα", future: "θα φορέσω", translation: "носить, одевать", category: "daily",
    examples: { present: [{"gr": "Φοράω παλτό τον χειμώνα.", "ru": "Ношу пальто зимой."}, {"gr": "Τι φοράς σήμερα;", "ru": "Что ты сегодня надел?"}], aorist: [{"gr": "Φόρεσα το καλό μου φόρεμα.", "ru": "Надела своё лучшее платье."}, {"gr": "Φόρεσε ζακέτα γιατί κάνει κρύο.", "ru": "Надень куртку, потому что холодно."}], future: [{"gr": "Θα φορέσω κόκκινο αύριο.", "ru": "Завтра надену красное."}, {"gr": "Τι θα φορέσεις;", "ru": "Что ты наденешь?"}] }
  },
  {
    id: 61, present: "χρειάζομαι", aorist: "χρειάστηκα", future: "θα χρειαστώ", translation: "нуждаться, иметь нужду", category: "basic",
    examples: { present: [{"gr": "Χρειάζομαι βοήθεια.", "ru": "Мне нужна помощь."}, {"gr": "Δεν χρειάζεσαι τίποτα;", "ru": "Тебе ничего не нужно?"}], aorist: [{"gr": "Χρειάστηκα χρόνο να σκεφτώ.", "ru": "Мне понадобилось время подумать."}, {"gr": "Χρειάστηκε ένα λεπτό.", "ru": "Ему понадобилась минута."}], future: [{"gr": "Θα χρειαστώ τη βοήθειά σου.", "ru": "Мне понадобится твоя помощь."}, {"gr": "Θα χρειαστεί περισσότερο χρόνο.", "ru": "Это займёт больше времени."}] }
  },
  {
    id: 62, present: "ευχαριστώ", aorist: "ευχαρίστησα", future: "θα ευχαριστήσω", translation: "благодарить", category: "communication",
    examples: { present: [{"gr": "Σε ευχαριστώ πολύ!", "ru": "Большое тебе спасибо!"}, {"gr": "Ευχαριστώ για τη βοήθεια.", "ru": "Благодарю за помощь."}], aorist: [{"gr": "Τον ευχαρίστησα για το δώρο.", "ru": "Поблагодарил его за подарок."}, {"gr": "Τους ευχαρίστησα όλους.", "ru": "Поблагодарил всех."}], future: [{"gr": "Θα σε ευχαριστήσω αύριο.", "ru": "Поблагодарю тебя завтра."}, {"gr": "Πώς θα τον ευχαριστήσω;", "ru": "Как мне его отблагодарить?"}] }
  },
  {
    id: 63, present: "μένω", aorist: "έμεινα", future: "θα μείνω", translation: "жить, оставаться", category: "daily",
    examples: { present: [{"gr": "Μένω στη Λευκωσία.", "ru": "Живу в Никосии."}, {"gr": "Πού μένεις;", "ru": "Где ты живёшь?"}], aorist: [{"gr": "Έμεινα σπίτι χτες.", "ru": "Вчера остался дома."}, {"gr": "Πόσο έμεινες στην Αθήνα;", "ru": "Сколько ты пробыл в Афинах?"}], future: [{"gr": "Θα μείνω εδώ για πάντα.", "ru": "Останусь здесь навсегда."}, {"gr": "Θα μείνεις ακόμη;", "ru": "Ты ещё останешься?"}] }
  },
  {
    id: 64, present: "ξεκουράζομαι", aorist: "ξεκουράστηκα", future: "θα ξεκουραστώ", translation: "отдыхать, расслабляться", category: "daily",
    examples: { present: [{"gr": "Ξεκουράζομαι το Σαββατοκύριακο.", "ru": "Отдыхаю по выходным."}, {"gr": "Ξεκουράσου λίγο.", "ru": "Отдохни немного."}], aorist: [{"gr": "Ξεκουράστηκα πολύ στις διακοπές.", "ru": "Хорошо отдохнул в отпуске."}, {"gr": "Ξεκουράστηκες;", "ru": "Ты отдохнул?"}], future: [{"gr": "Θα ξεκουραστώ αύριο.", "ru": "Завтра отдохну."}, {"gr": "Θα ξεκουραστούμε στην παραλία.", "ru": "Отдохнём на пляже."}] }
  },
  {
    id: 65, present: "περνάω", aorist: "πέρασα", future: "θα περάσω", translation: "проходить, проводить время", category: "daily",
    examples: { present: [{"gr": "Πώς περνάς;", "ru": "Как поживаешь?"}, {"gr": "Περνάω καλά εδώ.", "ru": "Хорошо провожу время здесь."}], aorist: [{"gr": "Πέρασα υπέροχα στις διακοπές.", "ru": "Прекрасно провёл отпуск."}, {"gr": "Πέρασε η ώρα γρήγορα.", "ru": "Время прошло быстро."}], future: [{"gr": "Θα περάσω από το σπίτι σου.", "ru": "Зайду к тебе домой."}, {"gr": "Θα περάσουμε καλά.", "ru": "Хорошо проведём время."}] }
  },
  {
    id: 66, present: "τηλεφωνώ", aorist: "τηλεφώνησα", future: "θα τηλεφωνήσω", translation: "звонить по телефону", category: "communication",
    examples: { present: [{"gr": "Τηλεφωνώ στη μαμά μου κάθε μέρα.", "ru": "Звоню маме каждый день."}, {"gr": "Μου τηλεφωνεί αργά.", "ru": "Он звонит мне поздно."}], aorist: [{"gr": "Τηλεφώνησα χτες αλλά δεν απαντούσες.", "ru": "Звонил вчера, но ты не отвечал."}, {"gr": "Τηλεφώνησε ο γιατρός.", "ru": "Позвонил врач."}], future: [{"gr": "Θα σου τηλεφωνήσω αύριο.", "ru": "Позвоню тебе завтра."}, {"gr": "Θα τηλεφωνήσεις;", "ru": "Ты позвонишь?"}] }
  },
  {
    id: 67, present: "ανεβαίνω", aorist: "ανέβηκα", future: "θα ανεβώ", translation: "подниматься, взбираться", category: "movement",
    examples: { present: [{"gr": "Ανεβαίνω τις σκάλες.", "ru": "Поднимаюсь по лестнице."}, {"gr": "Ανεβαίνω στον τέταρτο όροφο.", "ru": "Поднимаюсь на четвёртый этаж."}], aorist: [{"gr": "Ανέβηκα στο βουνό.", "ru": "Поднялся на гору."}, {"gr": "Ανέβηκε στο τρένο.", "ru": "Он сел в поезд."}], future: [{"gr": "Θα ανεβώ με το ασανσέρ.", "ru": "Поднимусь на лифте."}, {"gr": "Θα ανεβείς μαζί μου;", "ru": "Поднимешься со мной?"}] }
  },
  {
    id: 68, present: "κατεβαίνω", aorist: "κατέβηκα", future: "θα κατεβώ", translation: "спускаться", category: "movement",
    examples: { present: [{"gr": "Κατεβαίνω στο ισόγειο.", "ru": "Спускаюсь на первый этаж."}, {"gr": "Κατεβαίνω από το λεωφορείο.", "ru": "Выхожу из автобуса."}], aorist: [{"gr": "Κατέβηκα τις σκάλες γρήγορα.", "ru": "Быстро спустился по лестнице."}, {"gr": "Κατέβηκε στην παραλία.", "ru": "Спустился к пляжу."}], future: [{"gr": "Θα κατεβώ σε πέντε λεπτά.", "ru": "Спущусь через пять минут."}, {"gr": "Θα κατεβείτε εδώ;", "ru": "Вы выходите здесь?"}] }
  },
  {
    id: 69, present: "φτάνω", aorist: "έφτασα", future: "θα φτάσω", translation: "прибывать, достигать", category: "movement",
    examples: { present: [{"gr": "Φτάνω στη δουλειά στις οκτώ.", "ru": "Прихожу на работу в восемь."}, {"gr": "Το τρένο φτάνει αύριο.", "ru": "Поезд прибывает завтра."}], aorist: [{"gr": "Έφτασα σπίτι αργά.", "ru": "Пришёл домой поздно."}, {"gr": "Πότε έφτασες;", "ru": "Когда ты прибыл?"}], future: [{"gr": "Θα φτάσω στις δύο.", "ru": "Приеду в два."}, {"gr": "Πότε θα φτάσεις;", "ru": "Когда ты приедешь?"}] }
  },
  {
    id: 70, present: "βγαίνω", aorist: "βγήκα", future: "θα βγω", translation: "выходить", category: "movement",
    examples: { present: [{"gr": "Βγαίνω έξω κάθε βράδυ.", "ru": "Выхожу на улицу каждый вечер."}, {"gr": "Βγαίνεις απόψε;", "ru": "Ты выходишь сегодня вечером?"}], aorist: [{"gr": "Βγήκα με φίλους χτες.", "ru": "Вчера вышел с друзьями."}, {"gr": "Βγήκε από το σπίτι.", "ru": "Он вышел из дома."}], future: [{"gr": "Θα βγούμε το Σάββατο;", "ru": "Выйдем в субботу?"}, {"gr": "Θα βγω αύριο.", "ru": "Выйду завтра."}] }
  },
  {
    id: 71, present: "κοστίζω", aorist: "κόστισε", future: "θα κοστίσει", translation: "стоить (цена)", category: "shopping",
    examples: { present: [{"gr": "Πόσο κοστίζει αυτό;", "ru": "Сколько это стоит?"}, {"gr": "Κοστίζει πολύ.", "ru": "Стоит дорого."}], aorist: [{"gr": "Κόστισε πενήντα ευρώ.", "ru": "Это стоило пятьдесят евро."}, {"gr": "Πόσο κόστισε;", "ru": "Сколько это стоило?"}], future: [{"gr": "Θα κοστίσει πολύ;", "ru": "Это будет дорого?"}, {"gr": "Δεν θα κοστίσει πολύ.", "ru": "Это не будет дорого."}] }
  },
  {
    id: 72, present: "πληρώνω", aorist: "πλήρωσα", future: "θα πληρώσω", translation: "платить", category: "shopping",
    examples: { present: [{"gr": "Πληρώνω με κάρτα.", "ru": "Плачу картой."}, {"gr": "Πώς θέλετε να πληρώσετε;", "ru": "Как вы хотите заплатить?"}], aorist: [{"gr": "Πλήρωσα τον λογαριασμό.", "ru": "Заплатил по счёту."}, {"gr": "Ποιος πλήρωσε;", "ru": "Кто заплатил?"}], future: [{"gr": "Θα πληρώσω εγώ.", "ru": "Я заплачу."}, {"gr": "Θα πληρώσεις με μετρητά;", "ru": "Ты заплатишь наличными?"}] }
  },
  {
    id: 73, present: "πέφτω", aorist: "έπεσα", future: "θα πέσω", translation: "падать", category: "physical",
    examples: { present: [{"gr": "Πέφτω από την κούνια.", "ru": "Падаю с качелей."}, {"gr": "Τα φύλλα πέφτουν.", "ru": "Листья падают."}], aorist: [{"gr": "Έπεσα στον δρόμο.", "ru": "Упал на улице."}, {"gr": "Έπεσε το τηλέφωνο.", "ru": "Телефон упал."}], future: [{"gr": "Πρόσεχε, θα πέσεις!", "ru": "Осторожно, упадёшь!"}, {"gr": "Δεν θα πέσω.", "ru": "Я не упаду."}] }
  },
  {
    id: 74, present: "ετοιμάζω", aorist: "ετοίμασα", future: "θα ετοιμάσω", translation: "готовить, подготавливать", category: "daily",
    examples: { present: [{"gr": "Ετοιμάζω το φαγητό.", "ru": "Готовлю еду."}, {"gr": "Ετοιμάζεσαι;", "ru": "Ты готовишься?"}], aorist: [{"gr": "Ετοίμασα τη βαλίτσα μου.", "ru": "Собрал свой чемодан."}, {"gr": "Τι ετοίμασες για το πάρτι;", "ru": "Что ты приготовил для вечеринки?"}], future: [{"gr": "Θα ετοιμάσω δείπνο.", "ru": "Приготовлю ужин."}, {"gr": "Θα ετοιμαστείς γρήγορα;", "ru": "Ты быстро соберёшься?"}] }
  },
  {
    id: 75, present: "γνωρίζω", aorist: "γνώρισα", future: "θα γνωρίσω", translation: "знать, познакомиться", category: "social",
    examples: { present: [{"gr": "Γνωρίζω αυτόν τον άνθρωπο.", "ru": "Знаю этого человека."}, {"gr": "Γνωρίζεις τον νέο δάσκαλο;", "ru": "Ты знаком с новым учителем?"}], aorist: [{"gr": "Γνώρισα τον φίλο μου στο σχολείο.", "ru": "Познакомился с другом в школе."}, {"gr": "Πού τους γνώρισες;", "ru": "Где ты с ними познакомился?"}], future: [{"gr": "Θα γνωρίσεις πολλούς ανθρώπους.", "ru": "Познакомишься со многими людьми."}, {"gr": "Θα σε γνωρίσω με φίλους μου.", "ru": "Познакомлю тебя с моими друзьями."}] }
  },
  {
    id: 76, present: "πιστεύω", aorist: "πίστεψα", future: "θα πιστέψω", translation: "верить, считать", category: "mental",
    examples: { present: [{"gr": "Πιστεύω ότι θα πάει καλά.", "ru": "Верю, что всё пройдёт хорошо."}, {"gr": "Πιστεύεις σε μένα;", "ru": "Ты веришь мне?"}], aorist: [{"gr": "Πίστεψα αυτό που μου είπε.", "ru": "Поверил тому, что он мне сказал."}, {"gr": "Δεν το πίστεψα.", "ru": "Не поверил этому."}], future: [{"gr": "Θα πιστέψεις όταν το δεις.", "ru": "Поверишь, когда увидишь."}, {"gr": "Δεν θα το πιστέψεις.", "ru": "Ты не поверишь."}] }
  },
  {
    id: 77, present: "κλείνω", aorist: "έκλεισα", future: "θα κλείσω", translation: "закрывать, резервировать", category: "basic",
    examples: { present: [{"gr": "Κλείνω την πόρτα.", "ru": "Закрываю дверь."}, {"gr": "Κλείνω τραπέζι στο εστιατόριο.", "ru": "Бронирую стол в ресторане."}], aorist: [{"gr": "Έκλεισα το παράθυρο.", "ru": "Закрыл окно."}, {"gr": "Έκλεισα δωμάτιο στο ξενοδοχείο.", "ru": "Забронировал комнату в гостинице."}], future: [{"gr": "Θα κλείσω τις πόρτες.", "ru": "Закрою двери."}, {"gr": "Θα κλείσεις ραντεβού;", "ru": "Ты запишешься на приём?"}] }
  },
  {
    id: 78, present: "ζητάω", aorist: "ζήτησα", future: "θα ζητήσω", translation: "просить, спрашивать", category: "communication",
    examples: { present: [{"gr": "Ζητάω βοήθεια.", "ru": "Прошу помощи."}, {"gr": "Ζητάω συγγνώμη.", "ru": "Прошу прощения."}], aorist: [{"gr": "Ζήτησα τον λογαριασμό.", "ru": "Попросил счёт."}, {"gr": "Ζήτησε άδεια.", "ru": "Попросил разрешения."}], future: [{"gr": "Θα ζητήσω βοήθεια.", "ru": "Попрошу помощи."}, {"gr": "Θα ζητήσεις συγγνώμη;", "ru": "Ты попросишь прощения?"}] }
  },
  {
    id: 79, present: "χαίρομαι", aorist: "χάρηκα", future: "θα χαρώ", translation: "радоваться", category: "emotion",
    examples: { present: [{"gr": "Χαίρομαι που σε βλέπω!", "ru": "Рад тебя видеть!"}, {"gr": "Χαίρομαι που είσαι εδώ.", "ru": "Рад, что ты здесь."}], aorist: [{"gr": "Χάρηκα πολύ για το δώρο.", "ru": "Очень обрадовался подарку."}, {"gr": "Χάρηκε να σε γνωρίσει.", "ru": "Ему было приятно с тобой познакомиться."}], future: [{"gr": "Θα χαρώ να έρθεις.", "ru": "Буду рад, если ты придёшь."}, {"gr": "Θα χαρεί πολύ.", "ru": "Он очень обрадуется."}] }
  },
  {
    id: 80, present: "φτιάχνω", aorist: "έφτιαξα", future: "θα φτιάξω", translation: "делать, чинить, готовить", category: "daily",
    examples: { present: [{"gr": "Φτιάχνω καφέ.", "ru": "Делаю кофе."}, {"gr": "Φτιάχνει το αυτοκίνητο.", "ru": "Чинит машину."}], aorist: [{"gr": "Έφτιαξα τσάι για όλους.", "ru": "Приготовил чай для всех."}, {"gr": "Έφτιαξε το πρόβλημα.", "ru": "Решил проблему."}], future: [{"gr": "Θα φτιάξω κέικ.", "ru": "Испеку торт."}, {"gr": "Θα φτιάξεις κάτι να φάμε;", "ru": "Приготовишь что-нибудь поесть?"}] }
  }
];
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                ...
                <div style={{ marginTop: 12, paddingTop: 12, borderTop: '1px solid #e5e7eb' }}>
                  ...
                  <div className="flex gap-2">
                    <button onClick={() => { const data = JSON.stringify({ progress, customVerbs }); const blob = new Blob([data],{type:'application/json'}); const url = URL.createObjectURL(blob); const a = document.createElement('a'); a.href=url; a.download='verbs-progress.json'; a.click(); URL.revokeObjectURL(url); }} className="flex-1 py-2 bg-gray-100 text-gray-700 rounded-lg text-sm font-medium hover:bg-gray-200">⬇ Скачать</button>
                    <button onClick={() => { const input = document.createElement('input'); input.type='file'; input.accept='.json'; input.onchange=(e)=>{ const r=new FileReader(); r.onload=(ev)=>{ try{ const d=JSON.parse(ev.target.result); if(d.progress) saveProgress(d.progress); if(d.customVerbs){setCustomVerbs(d.customVerbs);localStorage.setItem('greekVerbsCustomV2',JSON.stringify(d.customVerbs));} alert('Прогресс загружен!'); }catch{alert('Ошибка файла');} }; r.readAsText(e.target.files[0]); }; input.click(); }} className="flex-1 py-2 bg-gray-100 text-gray-700 rounded-lg text-sm font-medium hover:bg-gray-200">⬆ Загрузить</button>
                  </div>
                </div>
